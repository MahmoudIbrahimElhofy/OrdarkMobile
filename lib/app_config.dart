...
class AppConfig {
  static String copyright_text =
      "@Ordark.com " + this_year; //this shows in the splash screen
  static String app_name = "Ordark"; //this shows in the splash screen
  ...
  //configure this
  static const DOMAIN_PATH = "ordark.com"; //localhost
